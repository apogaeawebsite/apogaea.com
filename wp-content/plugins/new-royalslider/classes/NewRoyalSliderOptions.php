...
'caption' => array(
				...
				'video' => array(
		            ...
		            array(
		                ...
		                'type' => 'textarea',
		                'data-type' => 'str',
		                'default' => htmlentities('<iframe src="//www.youtube.com/embed/%id%?rel=1&autoplay=1&showinfo=0" frameborder="no"></iframe>')
		            ),
		            array(
		                'name' => 'vimeoCode',
				...
				'deeplinking' => array(
		            ...
		            array(
		                ...
		                'desc' => __( "Prefix that will be added to url. For example if you set it to 'gallery-', hash would look like this: #gallery-2 (for the second slide)", 'new_royalslider' ),
		                'type' => 'text',
		                'data-type' => 'str',
		                'delimeter' => true,
		                'default' => ''
